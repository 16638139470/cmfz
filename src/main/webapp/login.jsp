    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/a/getCode?time=" + new Date().getTime());
            });
        ...
        function login(){
                $.ajax({
                    ...
                    success:function (result) {
                      if(result=="success"){
                         /* window.location.assign("${pageContext.request.contextPath}/statics/main.jsp");*/
                            location.href="${pageContext.request.contextPath}/statics/main.jsp";
                      }
                      if(result=="账号或密码错误"){
                          alert(result);
                      }
                        ...
                        <form role="form" action="" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/a/getCode">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       type="test" name="enCode" id="form-code" required>
                            </div>
                            <input type="button" onclick="login()" style="width: 400px;border:1px solid #9d9d9d;border-radius: 4px;" id="loginButtonId" value="登录">
                        </form>
                    </div>
                </div>
            </div>
